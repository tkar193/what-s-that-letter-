...
% Find the right formatting for the expanded boxes to insert into
% insertShape function

expandedBBoxes2 = [final(:,1) final(:,2) final(:,3)-final(:,1)+1 final(:,4)-final(:,2)+1]
IExpandedBBoxes = insertShape(I,'Rectangle',expandedBBoxes2,'LineWidth',3);
